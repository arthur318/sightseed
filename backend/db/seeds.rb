...
a1 = Account.create(name: "Wells Fargo", industry: "Bank", shortlist: true, account_type: "corporate")
...
s1 = Stage.create(pipeline_id: p1.id, name: "Prospects", rank_index: 1)
...
source1 = Source.create(grant_id: g1.id, source_type: "board", lead_type: "direct")
source2 = Source.create(grant_id: g2.id, source_type: "board", lead_type: "indirect")
